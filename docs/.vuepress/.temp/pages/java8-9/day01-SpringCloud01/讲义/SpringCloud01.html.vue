...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713202807818.png" alt="image-20210713202807818"></p>
<p>单体架构的优缺点如下：</p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713203124797.png" alt="image-20210713203124797"></p>
<p>分布式架构的优缺点：</p>
<p><strong>优点：</strong></p>
<ul>
<li>降低服务耦合</li>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713203753373.png" alt="image-20210713203753373"></p>
...
<p>其中常见的组件包括：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713204155887.png" alt="image-20210713204155887"></p>
<p>另外，SpringCloud底层是依赖于SpringBoot的，并且有版本的兼容关系，如下：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713205003790.png" alt="image-20210713205003790"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713210800950.png" alt="image-20210713210800950"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713211009593.png" alt="image-20210713211009593"></p>
...
<p>首先，将课前资料提供的<code v-pre>cloud-order.sql</code>和<code v-pre>cloud-user.sql</code>导入到mysql中：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713211417049.png" alt="image-20210713211417049"></p>
<p>cloud-user表中初始数据如下：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713211550169.png" alt="image-20210713211550169"></p>
<p>cloud-order表中初始数据如下：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713211657319.png" alt="image-20210713211657319"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713211814094.png" alt="image-20210713211814094"></p>
<p>项目结构如下：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713212656887.png" alt="image-20210713212656887"></p>
<p>导入后，会在IDEA右下角出现弹窗：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713212349272.png" alt="image-20210713212349272"></p>
<p>点击弹窗，然后按下图选择：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713212336185.png" alt="image-20210713212336185"></p>
<p>会出现这样的菜单：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713212513324.png" alt="image-20210713212513324"></p>
<p>配置下项目使用的JDK：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713220736408.png" alt="image-20210713220736408"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713212749575.png" alt="image-20210713212749575"></p>
<p>根据id查询订单，返回值是Order对象，如图：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713212901725.png" alt="image-20210713212901725"></p>
<p>其中的user为null</p>
<p>在user-service中有一个根据id查询用户的接口：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713213146089.png" alt="image-20210713213146089"></p>
<p>查询的结果如图：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713213213075.png" alt="image-20210713213213075"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713213312278.png" alt="image-20210713213312278"></p>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>itcast<span class="token punctuation">.</span>order</span><span class="token punctuation">;</span>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713213959569.png" alt="image-20210713213959569"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713214404481.png" alt="image-20210713214404481"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713214925388.png" alt="image-20210713214925388"></p>
<p>大家思考几个问题：</p>
<ul>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713220104956.png" alt="image-20210713220104956"></p>
<p>回答之前的各个问题。</p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713220509769.png" alt="image-20210713220509769"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713220605881.png" alt="image-20210713220605881"></p>
<p>填写模块信息：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713220857396.png" alt="image-20210713220857396"></p>
<p>然后填写服务信息：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713221339022.png" alt="image-20210713221339022"></p>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>itcast<span class="token punctuation">.</span>eureka</span><span class="token punctuation">;</span>
...
<p>看到下面结果应该是成功了：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713222157190.png" alt="image-20210713222157190"></p>
...
<span class="token key atrule">eureka</span><span class="token punctuation">:</span>
  <span class="token key atrule">client</span><span class="token punctuation">:</span>
    <span class="token key atrule">service-url</span><span class="token punctuation">:</span>
      <span class="token key atrule">defaultZone</span><span class="token punctuation">:</span> http<span class="token punctuation">:</span>//127.0.0.1<span class="token punctuation">:</span>10086/eureka
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-启动多个user-service实例" tabindex="-1"><a class="header-anchor" href="#_3-启动多个user-service实例" aria-hidden="true">#</a> 3）启动多个user-service实例</h3>
<p>为了演示一个服务有多个实例的场景，我们添加一个SpringBoot的启动配置，再启动一个user-service。</p>
<p>首先，复制原来的user-service启动配置：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713222656562.png" alt="image-20210713222656562"></p>
<p>然后，在弹出的窗口中，填写信息：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713222757702.png" alt="image-20210713222757702"></p>
<p>现在，SpringBoot窗口会出现两个user-service启动配置：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713222841951.png" alt="image-20210713222841951"></p>
<p>不过，第一个是8081端口，第二个是8082端口。</p>
<p>启动两个user-service实例：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713223041491.png" alt="image-20210713223041491"></p>
<p>查看eureka-server管理页面：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713223150650.png" alt="image-20210713223150650"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713224049419.png" alt="image-20210713224049419"></p>
<p>修改order-service服务中的cn.itcast.order.service包下的OrderService类中的queryOrderById方法。修改访问的url路径，用服务名代替ip、端口：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713224245731.png" alt="image-20210713224245731"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713224517686.png" alt="image-20210713224517686"></p>
...
<p>显然有人帮我们根据service名称，获取到了服务实例的ip和端口。它就是<code v-pre>LoadBalancerInterceptor</code>，这个类会在对RestTemplate的请求进行拦截，然后从Eureka根据服务id获取服务列表，随后利用负载均衡算法得到真实的服务地址信息，替换服务id。</p>
<p>我们进行源码跟踪：</p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/1525620483637.png" alt="1525620483637"></p>
<p>可以看到这里的intercept方法，拦截了用户的HttpRequest请求，然后做了几件事：</p>
<ul>
<li><code v-pre>request.getURI()</code>：获取请求uri，本例中就是 http://user-service/user/8</li>
...
<p>继续跟入execute方法：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/1525620787090.png" alt="1525620787090"></p>
<p>代码是这样的：</p>
<ul>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/1525620835911.png" alt="1525620835911"></p>
<p>果然实现了负载均衡。</p>
<h3 id="_3-负载均衡策略irule" tabindex="-1"><a class="header-anchor" href="#_3-负载均衡策略irule" aria-hidden="true">#</a> 3）负载均衡策略IRule</h3>
<p>在刚才的代码中，可以看到获取服务使通过一个<code v-pre>getServer</code>方法来做负载均衡:</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/1525620835911.png" alt="1525620835911"></p>
<p>我们继续跟入：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/1544361421671.png" alt="1544361421671"></p>
<p>继续跟踪源码chooseServer方法，发现这么一段代码：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/1525622652849.png" alt="1525622652849"></p>
<p>我们看看这个rule是谁：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/1525622699666.png" alt="1525622699666"></p>
<p>这里的rule默认值是一个<code v-pre>RoundRobinRule</code>，看类的介绍：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/1525622754316.png" alt="1525622754316"></p>
<p>这不就是轮询的意思嘛。</p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713224724673.png" alt="image-20210713224724673"></p>
<p>基本流程如下：</p>
<ul>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713225653000.png" alt="image-20210713225653000"></p>
<p>不同规则的含义如下：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token operator">|</span> <span class="token operator">*</span><span class="token operator">*</span>内置负载均衡规则类<span class="token operator">*</span><span class="token operator">*</span>    <span class="token operator">|</span> <span class="token operator">*</span><span class="token operator">*</span>规则描述<span class="token operator">*</span><span class="token operator">*</span>                                                 <span class="token operator">|</span>
<span class="token operator">|</span> <span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">-</span> <span class="token operator">|</span> <span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span> <span class="token operator">|</span>
<span class="token operator">|</span> <span class="token class-name">RoundRobinRule</span>            <span class="token operator">|</span> 简单轮询服务列表来选择服务器。它是<span class="token class-name">Ribbon</span>默认的负载均衡规则。 <span class="token operator">|</span>
<span class="token operator">|</span> <span class="token class-name">AvailabilityFilteringRule</span> <span class="token operator">|</span> 对以下两种服务器进行忽略：   （<span class="token number">1</span>）在默认情况下，这台服务器如果<span class="token number">3</span>次连接失败，这台服务器就会被设置为“短路”状态。短路状态将持续<span class="token number">30</span>秒，如果再次连接失败，短路的持续时间就会几何级地增加。  （<span class="token number">2</span>）并发数过高的服务器。如果一个服务器的并发连接数过高，配置了<span class="token class-name">AvailabilityFilteringRule</span>规则的客户端也会将其忽略。并发连接数的上限，可以由客户端的<span class="token generics"><span class="token punctuation">&lt;</span>clientName<span class="token punctuation">></span></span><span class="token punctuation">.</span><span class="token generics"><span class="token punctuation">&lt;</span>clientConfigNameSpace<span class="token punctuation">></span></span><span class="token punctuation">.</span>ActiveConnectionsLimit属性进行配置。 <span class="token operator">|</span>
<span class="token operator">|</span> <span class="token class-name">WeightedResponseTimeRule</span>  <span class="token operator">|</span> 为每一个服务器赋予一个权重值。服务器响应时间越长，这个服务器的权重就越小。这个规则会随机选择服务器，这个权重值会影响服务器的选择。 <span class="token operator">|</span>
<span class="token operator">|</span> <span class="token operator">*</span><span class="token operator">*</span><span class="token class-name">ZoneAvoidanceRule</span><span class="token operator">*</span><span class="token operator">*</span>     <span class="token operator">|</span> 以区域可用的服务器为基础进行服务器的选择。使用<span class="token class-name">Zone</span>对服务器进行分类，这个<span class="token class-name">Zone</span>可以理解为一个机房、一个机架等。而后再对<span class="token class-name">Zone</span>内的多个服务做轮询。 <span class="token operator">|</span>
<span class="token operator">|</span> <span class="token class-name">BestAvailableRule</span>         <span class="token operator">|</span> 忽略那些短路的服务器，并选择并发数较低的服务器。             <span class="token operator">|</span>
<span class="token operator">|</span> <span class="token class-name">RandomRule</span>                <span class="token operator">|</span> 随机选择一个可用的服务器。                                   <span class="token operator">|</span>
<span class="token operator">|</span> <span class="token class-name">RetryRule</span>                 <span class="token operator">|</span> 重试机制的选择逻辑                                           <span class="token operator">|</span>


</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>默认的实现就是ZoneAvoidanceRule，是一种轮询方案</p>
...
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token key atrule">userservice</span><span class="token punctuation">:</span> <span class="token comment"># 给某个微服务配置负载均衡规则，这里是userservice服务</span>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713230444308.png" alt="image-20210713230444308"></p>
...
<p>在cloud-demo父工程的pom文件中的<code v-pre>&lt;dependencyManagement&gt;</code>中引入SpringCloudAlibaba的依赖：</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在user-service和order-service中的pom文件中引入nacos-discovery依赖：</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>com.alibaba.cloud<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
...
<h3 id="_2-配置nacos地址" tabindex="-1"><a class="header-anchor" href="#_2-配置nacos地址" aria-hidden="true">#</a> 2）配置nacos地址</h3>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713231439607.png" alt="image-20210713231439607"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713232522531.png" alt="image-20210713232522531"></p>
<p>微服务互相访问时，应该尽可能访问同集群实例，因为本地访问速度更快。当本集群内不可用时，才访问其它集群。例如：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713232658928.png" alt="image-20210713232658928"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713232916215.png" alt="image-20210713232916215"></p>
<p>我们再次复制一个user-service启动配置，添加属性：</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token parameter variable">-Dserver.port</span><span class="token operator">=</span><span class="token number">8083</span> -Dspring.cloud.nacos.discovery.cluster-name<span class="token operator">=</span>SH
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>配置如图所示：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713233528982.png" alt="image-20210713233528982"></p>
<p>启动UserApplication3后再次查看nacos控制台：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713233727923.png" alt="image-20210713233727923"></p>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>spring:
  cloud:
    nacos:
...
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token key atrule">userservice</span><span class="token punctuation">:</span>
  <span class="token key atrule">ribbon</span><span class="token punctuation">:</span>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713235133225.png" alt="image-20210713235133225"></p>
<p>在弹出的编辑窗口，修改权重：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210713235235219.png" alt="image-20210713235235219"></p>
<blockquote>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210714000101516.png" alt="image-20210714000101516"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210714000414781.png" alt="image-20210714000414781"></p>
<p>我们可以点击页面新增按钮，添加一个namespace：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210714000440143.png" alt="image-20210714000440143"></p>
<p>然后，填写表单：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210714000505928.png" alt="image-20210714000505928"></p>
<p>就能在页面看到一个新的namespace：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210714000522913.png" alt="image-20210714000522913"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210714000830703.png" alt="image-20210714000830703"></p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210714000837140.png" alt="image-20210714000837140"></p>
<p>此时访问order-service，因为namespace不同，会导致找不到userservice，控制台会报错：</p>
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210714000941256.png" alt="image-20210714000941256"></p>
...
<p><img src="@source/java8-9/day01-SpringCloud01/讲义/assets/image-20210714001728017.png" alt="image-20210714001728017"></p>
<ul>
<li>
