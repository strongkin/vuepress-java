...
<h1 id="_1-初识mq" tabindex="-1"><a class="header-anchor" href="#_1-初识mq" aria-hidden="true">#</a> 1.初识MQ</h1>
...
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717161939695.png" alt="image-20210717161939695"></p>
...
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717162004285.png" alt="image-20210717162004285"></p>
<p>总结：</p>
<p>同步调用的优点：</p>
<ul>
...
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210422095356088.png" alt="image-20210422095356088"></p>
...
<h1 id="_2-快速入门" tabindex="-1"><a class="header-anchor" href="#_2-快速入门" aria-hidden="true">#</a> 2.快速入门</h1>
<h2 id="_2-1-安装rabbitmq" tabindex="-1"><a class="header-anchor" href="#_2-1-安装rabbitmq" aria-hidden="true">#</a> 2.1.安装RabbitMQ</h2>
<p>安装RabbitMQ，参考课前资料：</p>
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717162628635.png" alt="image-20210717162628635"></p>
<p>MQ的基本结构：</p>
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717162752376.png" alt="image-20210717162752376"></p>
<p>RabbitMQ中的一些角色：</p>
<ul>
<li>publisher：生产者</li>
<li>consumer：消费者</li>
...
<h2 id="_2-2-rabbitmq消息模型" tabindex="-1"><a class="header-anchor" href="#_2-2-rabbitmq消息模型" aria-hidden="true">#</a> 2.2.RabbitMQ消息模型</h2>
<p>RabbitMQ官方提供了5个不同的Demo示例，对应了不同的消息模型：</p>
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717163332646.png" alt="image-20210717163332646"></p>
<h2 id="_2-3-导入demo工程" tabindex="-1"><a class="header-anchor" href="#_2-3-导入demo工程" aria-hidden="true">#</a> 2.3.导入Demo工程</h2>
<p>课前资料提供了一个Demo工程，mq-demo:</p>
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717163253264.png" alt="image-20210717163253264"></p>
<p>导入后可以看到结构如下：</p>
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717163604330.png" alt="image-20210717163604330"></p>
<p>包括三部分：</p>
<ul>
...
<p>简单队列模式的模型图：</p>
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717163434647.png" alt="image-20210717163434647"></p>
...
<h3 id="_2-4-1-publisher实现" tabindex="-1"><a class="header-anchor" href="#_2-4-1-publisher实现" aria-hidden="true">#</a> 2.4.1.publisher实现</h3>
<p>思路：</p>
<ul>
<li>建立连接</li>
<li>创建Channel</li>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-4-2-consumer实现" tabindex="-1"><a class="header-anchor" href="#_2-4-2-consumer实现" aria-hidden="true">#</a> 2.4.2.consumer实现</h3>
<p>代码思路：</p>
<ul>
<li>建立连接</li>
<li>创建Channel</li>
...
<h1 id="_3-springamqp" tabindex="-1"><a class="header-anchor" href="#_3-springamqp" aria-hidden="true">#</a> 3.SpringAMQP</h1>
...
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717164024967.png" alt="image-20210717164024967"></p>
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717164038678.png" alt="image-20210717164038678"></p>
...
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--AMQP依赖，包含RabbitMQ--></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在publisher服务中编写测试类SpringAmqpTest，并利用RabbitTemplate实现消息发送：</p>
...
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">rabbitmq</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">username</span><span class="token punctuation">:</span> itcast <span class="token comment"># 用户名</span>
    <span class="token key atrule">password</span><span class="token punctuation">:</span> <span class="token number">123321</span> <span class="token comment"># 密码</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在consumer服务的<code v-pre>cn.itcast.mq.listener</code>包中新建一个类SpringRabbitListener，代码如下：</p>
...
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717164238910.png" alt="image-20210717164238910"></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意到这个消费者sleep了1000秒，模拟任务耗时。</p>
...
<p>发布订阅的模型如图：</p>
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717165309625.png" alt="image-20210717165309625"></p>
...
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717165438225.png" alt="image-20210717165438225"></p>
...
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717165509466.png" alt="image-20210717165509466"></p>
...
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717165552676.png" alt="image-20210717165552676"></p>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@RabbitListener</span><span class="token punctuation">(</span>queues <span class="token operator">=</span> <span class="token string">"fanout.queue1"</span><span class="token punctuation">)</span>
...
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717170041447.png" alt="image-20210717170041447"></p>
<p>在Direct模型下：</p>
<ul>
...
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717170223317.png" alt="image-20210717170223317"></p>
...
<p>通配符规则：</p>
<p><code v-pre>#</code>：匹配一个或多个词</p>
<p><code v-pre>*</code>：匹配不多不少恰好1个词</p>
<p>举例：</p>
...
<p>​</p>
<p>图示：</p>
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717170705380.png" alt="image-20210717170705380"></p>
<p>解释：</p>
<ul>
<li>Queue1：绑定的是<code v-pre>china.#</code> ，因此凡是以 <code v-pre>china.</code>开头的<code v-pre>routing key</code> 都会被匹配到。包括china.news和china.weather</li>
<li>Queue2：绑定的是<code v-pre>#.news</code> ，因此凡是以 <code v-pre>.news</code>结尾的 <code v-pre>routing key</code> 都会被匹配。包括china.news和japan.news</li>
</ul>
<p>案例需求：</p>
<p>实现思路如下：</p>
<ol>
...
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210717170829229.png" alt="image-20210717170829229"></p>
...
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20200525170410401.png" alt="image-20200525170410401"></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>停止consumer服务</p>
<p>发送消息后查看控制台：</p>
<p><img src="@source/java8-9/day04-MQ/讲义/assets/image-20210422232835363.png" alt="image-20210422232835363"></p>
<h3 id="_3-7-2-配置json转换器" tabindex="-1"><a class="header-anchor" href="#_3-7-2-配置json转换器" aria-hidden="true">#</a> 3.7.2.配置JSON转换器</h3>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>配置消息转换器。</p>
<p>在启动类中添加一个Bean即可：</p>
