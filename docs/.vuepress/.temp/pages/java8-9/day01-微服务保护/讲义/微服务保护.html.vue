<template><div><h1 id="微服务保护" tabindex="-1"><a class="header-anchor" href="#微服务保护" aria-hidden="true">#</a> 微服务保护</h1>
<h1 id="_1-初识sentinel" tabindex="-1"><a class="header-anchor" href="#_1-初识sentinel" aria-hidden="true">#</a> 1.初识Sentinel</h1>
<h2 id="_1-1-雪崩问题及解决方案" tabindex="-1"><a class="header-anchor" href="#_1-1-雪崩问题及解决方案" aria-hidden="true">#</a> 1.1.雪崩问题及解决方案</h2>
<h3 id="_1-1-1-雪崩问题" tabindex="-1"><a class="header-anchor" href="#_1-1-1-雪崩问题" aria-hidden="true">#</a> 1.1.1.雪崩问题</h3>
<p>微服务中，服务间调用关系错综复杂，一个微服务往往依赖于多个其它微服务。</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/1533829099748.png" alt="1533829099748"></p>
<p>如图，如果服务提供者I发生了故障，当前的应用的部分业务因为依赖于服务I，因此也会被阻塞。此时，其它不依赖于服务I的业务似乎不受影响。</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/1533829198240.png" alt="1533829198240"></p>
<p>但是，依赖服务I的业务请求被阻塞，用户不会得到响应，则tomcat的这个线程不会释放，于是越来越多的用户请求到来，越来越多的线程会阻塞：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/1533829307389.png" alt="1533829307389"></p>
<p>服务器支持的线程和并发数有限，请求一直阻塞，会导致服务器资源耗尽，从而导致所有其它服务都不可用，那么当前服务也就不可用了。</p>
<p>那么，依赖于当前服务的其它服务随着时间的推移，最终也都会变的不可用，形成级联失败，雪崩就发生了：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715172710340.png" alt="image-20210715172710340"></p>
<h3 id="_1-1-2-超时处理" tabindex="-1"><a class="header-anchor" href="#_1-1-2-超时处理" aria-hidden="true">#</a> 1.1.2.超时处理</h3>
<p>解决雪崩问题的常见方式有四种：</p>
<p>•超时处理：设定超时时间，请求超过一定时间没有响应就返回错误信息，不会无休止等待</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715172820438.png" alt="image-20210715172820438"></p>
<h3 id="_1-1-3-仓壁模式" tabindex="-1"><a class="header-anchor" href="#_1-1-3-仓壁模式" aria-hidden="true">#</a> 1.1.3.仓壁模式</h3>
<p>方案2：仓壁模式</p>
<p>仓壁模式来源于船舱的设计：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715172946352.png" alt="image-20210715172946352"></p>
<p>船舱都会被隔板分离为多个独立空间，当船体破损时，只会导致部分空间进入，将故障控制在一定范围内，避免整个船体都被淹没。</p>
<p>于此类似，我们可以限定每个业务能使用的线程数，避免耗尽整个tomcat的资源，因此也叫线程隔离。</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715173215243.png" alt="image-20210715173215243"></p>
<h3 id="_1-1-4-断路器" tabindex="-1"><a class="header-anchor" href="#_1-1-4-断路器" aria-hidden="true">#</a> 1.1.4.断路器</h3>
<p>断路器模式：由<strong>断路器</strong>统计业务执行的异常比例，如果超出阈值则会<strong>熔断</strong>该业务，拦截访问该业务的一切请求。</p>
<p>断路器会统计访问某个服务的请求数量，异常比例：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715173327075.png" alt="image-20210715173327075"></p>
<p>当发现访问服务D的请求异常比例过高时，认为服务D有导致雪崩的风险，会拦截访问服务D的一切请求，形成熔断：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715173428073.png" alt="image-20210715173428073"></p>
<h3 id="_1-1-5-限流" tabindex="-1"><a class="header-anchor" href="#_1-1-5-限流" aria-hidden="true">#</a> 1.1.5.限流</h3>
<p><strong>流量控制</strong>：限制业务访问的QPS，避免服务因流量的突增而故障。</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715173555158.png" alt="image-20210715173555158"></p>
<h3 id="_1-1-6-总结" tabindex="-1"><a class="header-anchor" href="#_1-1-6-总结" aria-hidden="true">#</a> 1.1.6.总结</h3>
<p>什么是雪崩问题？</p>
<ul>
...
<h2 id="_1-2-服务保护技术对比" tabindex="-1"><a class="header-anchor" href="#_1-2-服务保护技术对比" aria-hidden="true">#</a> 1.2.服务保护技术对比</h2>
<p>在SpringCloud当中支持多种服务保护技术：</p>
<ul>
<li><a href="https://github.com/Netflix/Hystrix" target="_blank" rel="noopener noreferrer">Netfix Hystrix<ExternalLinkIcon/></a></li>
<li><a href="https://github.com/alibaba/Sentinel" target="_blank" rel="noopener noreferrer">Sentinel<ExternalLinkIcon/></a></li>
<li><a href="https://github.com/resilience4j/resilience4j" target="_blank" rel="noopener noreferrer">Resilience4J<ExternalLinkIcon/></a></li>
</ul>
...
<h2 id="_1-3-sentinel介绍和安装" tabindex="-1"><a class="header-anchor" href="#_1-3-sentinel介绍和安装" aria-hidden="true">#</a> 1.3.Sentinel介绍和安装</h2>
<h3 id="_1-3-1-初识sentinel" tabindex="-1"><a class="header-anchor" href="#_1-3-1-初识sentinel" aria-hidden="true">#</a> 1.3.1.初识Sentinel</h3>
...
<h3 id="_1-3-2-安装sentinel" tabindex="-1"><a class="header-anchor" href="#_1-3-2-安装sentinel" aria-hidden="true">#</a> 1.3.2.安装Sentinel</h3>
<p>1）下载</p>
<p>sentinel官方提供了UI控制台，方便我们对系统做限流设置。大家可以在<a href="https://github.com/alibaba/Sentinel/releases" target="_blank" rel="noopener noreferrer">GitHub<ExternalLinkIcon/></a>下载。</p>
<p>课前资料也提供了下载好的jar包：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715174252531.png" alt="image-20210715174252531"></p>
<p>2）运行</p>
<p>将jar包放到任意非中文目录，执行命令：</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">java</span> <span class="token parameter variable">-jar</span> sentinel-dashboard-1.8.1.jar
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果要修改Sentinel的默认端口、账户、密码，可以通过下列配置：</p>
<table>
<thead>
<tr>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>3）访问</p>
<p>访问http://localhost:8080页面，就可以看到sentinel的控制台了：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715190827846.png" alt="image-20210715190827846"></p>
<p>需要输入账号和密码，默认都是：sentinel</p>
<p>登录后，发现一片空白，什么都没有：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715191134448.png" alt="image-20210715191134448"></p>
<p>这是因为我们还没有与微服务整合。</p>
<h2 id="_1-4-微服务整合sentinel" tabindex="-1"><a class="header-anchor" href="#_1-4-微服务整合sentinel" aria-hidden="true">#</a> 1.4.微服务整合Sentinel</h2>
<p>我们在order-service中整合sentinel，并连接sentinel的控制台，步骤如下：</p>
<p>1）引入sentinel依赖</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--sentinel--></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2）配置控制台</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3）访问order-service的任意端点</p>
<p>打开浏览器，访问http://localhost:8088/order/101，这样才能触发sentinel的监控。</p>
<p>然后再访问sentinel的控制台，查看效果：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715191241799.png" alt="image-20210715191241799"></p>
<h1 id="_2-流量控制" tabindex="-1"><a class="header-anchor" href="#_2-流量控制" aria-hidden="true">#</a> 2.流量控制</h1>
<p>雪崩问题虽然有四种方案，但是限流是避免服务因突发的流量而发生故障，是对微服务雪崩问题的预防。我们先学习这种模式。</p>
<h2 id="_2-1-簇点链路" tabindex="-1"><a class="header-anchor" href="#_2-1-簇点链路" aria-hidden="true">#</a> 2.1.簇点链路</h2>
...
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715191757319.png" alt="image-20210715191757319"></p>
...
<h2 id="_2-1-快速入门" tabindex="-1"><a class="header-anchor" href="#_2-1-快速入门" aria-hidden="true">#</a> 2.1.快速入门</h2>
<h3 id="_2-1-1-示例" tabindex="-1"><a class="header-anchor" href="#_2-1-1-示例" aria-hidden="true">#</a> 2.1.1.示例</h3>
<p>点击资源/order/{orderId}后面的流控按钮，就可以弹出表单。</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715191757319.png" alt="image-20210715191757319"></p>
<p>表单中可以填写限流规则，如下：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715192010657.png" alt="image-20210715192010657"></p>
<p>其含义是限制 /order/{orderId}这个资源的单机QPS为1，即每秒只允许1次请求，超出的请求会被拦截并报错。</p>
<h3 id="_2-1-2-练习" tabindex="-1"><a class="header-anchor" href="#_2-1-2-练习" aria-hidden="true">#</a> 2.1.2.练习：</h3>
<p>需求：给 /order/{orderId}这个资源设置流控规则，QPS不能超过 5，然后测试。</p>
<p>1）首先在sentinel控制台添加限流规则</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715192455429.png" alt="image-20210715192455429"></p>
<p>2）利用jmeter测试</p>
<p>如果没有用过jmeter，可以参考课前资料提供的文档《Jmeter快速入门.md》</p>
<p>课前资料提供了编写好的Jmeter测试样例：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715200431615.png" alt="image-20210715200431615"></p>
<p>打开jmeter，导入课前资料提供的测试样例：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715200537171.png" alt="image-20210715200537171"></p>
<p>选择：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715200635414.png" alt="image-20210715200635414"></p>
<p>20个用户，2秒内运行完，QPS是10，超过了5.</p>
<p>选中<code v-pre>流控入门，QPS&lt;5</code>右键运行：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715200804594.png" alt="image-20210715200804594"></p>
<blockquote>
<p>注意，不要点击菜单中的执行按钮来运行。</p>
</blockquote>
<p>结果：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715200853671.png" alt="image-20210715200853671"></p>
<p>可以看到，成功的请求每次只有5个</p>
<h2 id="_2-2-流控模式" tabindex="-1"><a class="header-anchor" href="#_2-2-流控模式" aria-hidden="true">#</a> 2.2.流控模式</h2>
...
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715201827886.png" alt="image-20210715201827886"></p>
<p>快速入门测试的就是直接模式。</p>
<h3 id="_2-2-1-关联模式" tabindex="-1"><a class="header-anchor" href="#_2-2-1-关联模式" aria-hidden="true">#</a> 2.2.1.关联模式</h3>
<p><strong>关联模式</strong>：统计与当前资源相关的另一个资源，触发阈值时，对当前资源限流</p>
<p><strong>配置规则</strong>：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210715202540786.png" alt="image-20210715202540786"></p>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@GetMapping</span><span class="token punctuation">(</span><span class="token string">"/query"</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2）定义/order/update端点，模拟订单更新</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@GetMapping</span><span class="token punctuation">(</span><span class="token string">"/update"</span><span class="token punctuation">)</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重启服务，查看sentinel控制台的簇点链路：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716101805951.png" alt="image-20210716101805951"></p>
<p>3）配置流控规则</p>
<p>对哪个端点限流，就点击哪个端点后面的按钮。我们是对订单查询/order/query限流，因此点击它后面的按钮：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716101934499.png" alt="image-20210716101934499"></p>
<p>在表单中填写流控规则：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716102103814.png" alt="image-20210716102103814"></p>
<p>4）在Jmeter测试</p>
<p>选择《流控模式-关联》：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716102416266.png" alt="image-20210716102416266"></p>
<p>可以看到1000个用户，100秒，因此QPS为10，超过了我们设定的阈值：5</p>
<p>查看http请求：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716102532554.png" alt="image-20210716102532554"></p>
<p>请求的目标是/order/update，这样这个断点就会触发阈值。</p>
<p>但限流的目标是/order/query，我们在浏览器访问，可以发现：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716102636030.png" alt="image-20210716102636030"></p>
<p>确实被限流了。</p>
<p>5）总结</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716103143002.png" alt="image-20210716103143002"></p>
<h3 id="_2-2-2-链路模式" tabindex="-1"><a class="header-anchor" href="#_2-2-2-链路模式" aria-hidden="true">#</a> 2.2.2.链路模式</h3>
...
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716103536346.png" alt="image-20210716103536346"></p>
...
<p>实现：</p>
<h4 id="_1-添加查询商品方法" tabindex="-1"><a class="header-anchor" href="#_1-添加查询商品方法" aria-hidden="true">#</a> 1）添加查询商品方法</h4>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-查询订单时-查询商品" tabindex="-1"><a class="header-anchor" href="#_2-查询订单时-查询商品" aria-hidden="true">#</a> 2）查询订单时，查询商品</h4>
...
<span class="token keyword">public</span> <span class="token class-name">String</span> <span class="token function">queryOrder</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">return</span> <span class="token string">"查询订单成功"</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-新增订单-查询商品" tabindex="-1"><a class="header-anchor" href="#_3-新增订单-查询商品" aria-hidden="true">#</a> 3）新增订单，查询商品</h4>
<p>在order-service的OrderController中，修改/order/save端点，模拟新增订单：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@GetMapping</span><span class="token punctuation">(</span><span class="token string">"/save"</span><span class="token punctuation">)</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-给查询商品添加资源标记" tabindex="-1"><a class="header-anchor" href="#_4-给查询商品添加资源标记" aria-hidden="true">#</a> 4）给查询商品添加资源标记</h4>
<p>默认情况下，OrderService中的方法是不被Sentinel监控的，需要我们自己通过注解来标记要监控的方法。</p>
<p>给OrderService的queryGoods方法添加@SentinelResource注解：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@SentinelResource</span><span class="token punctuation">(</span><span class="token string">"goods"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">queryGoods</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>err<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"查询商品"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>链路模式中，是对不同来源的两个链路做监控。但是sentinel默认会给进入SpringMVC的所有请求设置同一个root资源，会导致链路模式失效。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重启服务，访问/order/query和/order/save，可以查看到sentinel的簇点链路规则中，出现了新的资源：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716105227163.png" alt="image-20210716105227163"></p>
<h4 id="_5-添加流控规则" tabindex="-1"><a class="header-anchor" href="#_5-添加流控规则" aria-hidden="true">#</a> 5）添加流控规则</h4>
<p>点击goods资源后面的流控按钮，在弹出的表单中填写下面信息：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716105408723.png" alt="image-20210716105408723"></p>
<p>只统计从/order/query进入/goods的资源，QPS阈值为2，超出则被限流。</p>
<h4 id="_6-jmeter测试" tabindex="-1"><a class="header-anchor" href="#_6-jmeter测试" aria-hidden="true">#</a> 6）Jmeter测试</h4>
<p>选择《流控模式-链路》：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716105612312.png" alt="image-20210716105612312"></p>
<p>可以看到这里200个用户，50秒内发完，QPS为4，超过了我们设定的阈值2</p>
<p>一个http请求是访问/order/save：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716105812789.png" alt="image-20210716105812789"></p>
<p>运行的结果：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716110027064.png" alt="image-20210716110027064"></p>
<p>完全不受影响。</p>
<p>另一个是访问/order/query：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716105855951.png" alt="image-20210716105855951"></p>
<p>运行结果：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716105956401.png" alt="image-20210716105956401"></p>
<p>每次只有2个通过。</p>
<h3 id="_2-2-3-总结" tabindex="-1"><a class="header-anchor" href="#_2-2-3-总结" aria-hidden="true">#</a> 2.2.3.总结</h3>
<p>流控模式有哪些？</p>
<p>•直接：对当前资源限流</p>
<p>•关联：高优先级资源触发阈值，对低优先级资源限流。</p>
<p>•链路：阈值统计时，只统计从指定资源进入当前资源的请求，是对请求来源的限流</p>
<h2 id="_2-3-流控效果" tabindex="-1"><a class="header-anchor" href="#_2-3-流控效果" aria-hidden="true">#</a> 2.3.流控效果</h2>
<p>在流控的高级选项中，还有一个流控效果选项：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716110225104.png" alt="image-20210716110225104"></p>
...
<h3 id="_2-3-1-warm-up" tabindex="-1"><a class="header-anchor" href="#_2-3-1-warm-up" aria-hidden="true">#</a> 2.3.1.warm up</h3>
...
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716110629796.png" alt="image-20210716110629796"></p>
<p><strong>案例</strong></p>
<p>需求：给/order/{orderId}这个资源设置限流，最大QPS为10，利用warm up效果，预热时长为5秒</p>
<h4 id="_1-配置流控规则" tabindex="-1"><a class="header-anchor" href="#_1-配置流控规则" aria-hidden="true">#</a> 1）配置流控规则：</h4>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716111012387.png" alt="image-20210716111012387"></p>
<h4 id="_2-jmeter测试" tabindex="-1"><a class="header-anchor" href="#_2-jmeter测试" aria-hidden="true">#</a> 2）Jmeter测试</h4>
<p>选择《流控效果，warm up》：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716111136699.png" alt="image-20210716111136699"></p>
<p>QPS为10.</p>
<p>刚刚启动时，大部分请求失败，成功的只有3个，说明QPS被限定在3：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716111303701.png" alt="image-20210716111303701"></p>
<p>随着时间推移，成功比例越来越高：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716111404717.png" alt="image-20210716111404717"></p>
<p>到Sentinel控制台查看实时监控：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716111526480.png" alt="image-20210716111526480"></p>
<p>一段时间后：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716111658541.png" alt="image-20210716111658541"></p>
<h3 id="_2-3-2-排队等待" tabindex="-1"><a class="header-anchor" href="#_2-3-2-排队等待" aria-hidden="true">#</a> 2.3.2.排队等待</h3>
...
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716113147176.png" alt="image-20210716113147176"></p>
<p>如果使用队列模式做流控，所有进入的请求都要排队，以固定的200ms的间隔执行，QPS会变的很平滑：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716113426524.png" alt="image-20210716113426524"></p>
<p>平滑的QPS曲线，对于服务器来说是更友好的。</p>
<p><strong>案例</strong></p>
<p>需求：给/order/{orderId}这个资源设置限流，最大QPS为10，利用排队的流控效果，超时时长设置为5s</p>
<h4 id="_1-添加流控规则" tabindex="-1"><a class="header-anchor" href="#_1-添加流控规则" aria-hidden="true">#</a> 1）添加流控规则</h4>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716114048918.png" alt="image-20210716114048918"></p>
<h4 id="_2-jmeter测试-1" tabindex="-1"><a class="header-anchor" href="#_2-jmeter测试-1" aria-hidden="true">#</a> 2）Jmeter测试</h4>
<p>选择《流控效果，队列》：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716114243558.png" alt="image-20210716114243558"></p>
<p>QPS为15，已经超过了我们设定的10。</p>
<p>如果是之前的 快速失败、warmup模式，超出的请求应该会直接报错。</p>
<p>但是我们看看队列模式的运行结果：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716114429361.png" alt="image-20210716114429361"></p>
<p>全部都通过了。</p>
<p>再去sentinel查看实时监控的QPS曲线：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716114522935.png" alt="image-20210716114522935"></p>
<p>QPS非常平滑，一致保持在10，但是超出的请求没有被拒绝，而是放入队列。因此<strong>响应时间</strong>（等待时间）会越来越长。</p>
<p>当队列满了以后，才会有部分请求失败：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716114651137.png" alt="image-20210716114651137"></p>
<h3 id="_2-3-3-总结" tabindex="-1"><a class="header-anchor" href="#_2-3-3-总结" aria-hidden="true">#</a> 2.3.3.总结</h3>
<p>流控效果有哪些？</p>
<ul>
<li>
...
<h2 id="_2-4-热点参数限流" tabindex="-1"><a class="header-anchor" href="#_2-4-热点参数限流" aria-hidden="true">#</a> 2.4.热点参数限流</h2>
<p>之前的限流是统计访问某个资源的所有请求，判断是否超过QPS阈值。而热点参数限流是<strong>分别统计参数值相同的请求</strong>，判断是否超过QPS阈值。</p>
<h3 id="_2-4-1-全局参数限流" tabindex="-1"><a class="header-anchor" href="#_2-4-1-全局参数限流" aria-hidden="true">#</a> 2.4.1.全局参数限流</h3>
<p>例如，一个根据id查询商品的接口：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716115014663.png" alt="image-20210716115014663"></p>
<p>访问/goods/{id}的请求中，id参数值会有变化，热点参数限流会根据参数值分别统计QPS，统计结果：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716115131463.png" alt="image-20210716115131463"></p>
<p>当id=1的请求触发阈值被限流时，id值不为1的请求不受影响。</p>
<p>配置示例：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716115232426.png" alt="image-20210716115232426"></p>
<p>代表的含义是：对hot这个资源的0号参数（第一个参数）做统计，每1秒<strong>相同参数值</strong>的请求数不能超过5</p>
<h3 id="_2-4-2-热点参数限流" tabindex="-1"><a class="header-anchor" href="#_2-4-2-热点参数限流" aria-hidden="true">#</a> 2.4.2.热点参数限流</h3>
<p>刚才的配置中，对查询商品这个接口的所有商品一视同仁，QPS都限定为5.</p>
<p>而在实际开发中，可能部分商品是热点商品，例如秒杀商品，我们希望这部分商品的QPS限制与其它商品不一样，高一些。那就需要配置热点参数限流的高级选项了：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716115717523.png" alt="image-20210716115717523"></p>
<p>结合上一个配置，这里的含义是对0号的long类型参数限流，每1秒相同参数的QPS不能超过5，有两个例外：</p>
<p>•如果参数值是100，则每1秒允许的QPS为10</p>
<p>•如果参数值是101，则每1秒允许的QPS为15</p>
<h3 id="_2-4-4-案例" tabindex="-1"><a class="header-anchor" href="#_2-4-4-案例" aria-hidden="true">#</a> 2.4.4.案例</h3>
...
<h4 id="_1-标记资源" tabindex="-1"><a class="header-anchor" href="#_1-标记资源" aria-hidden="true">#</a> 1）标记资源</h4>
<p>给order-service中的OrderController中的/order/{orderId}资源添加注解：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716120033572.png" alt="image-20210716120033572"></p>
<h4 id="_2-热点参数限流规则" tabindex="-1"><a class="header-anchor" href="#_2-热点参数限流规则" aria-hidden="true">#</a> 2）热点参数限流规则</h4>
<p>访问该接口，可以看到我们标记的hot资源出现了：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716120208509.png" alt="image-20210716120208509"></p>
<p>这里不要点击hot后面的按钮，页面有BUG</p>
<p>点击左侧菜单中<strong>热点规则</strong>菜单：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716120319009.png" alt="image-20210716120319009"></p>
<p>点击新增，填写表单：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716120536714.png" alt="image-20210716120536714"></p>
<h4 id="_3-jmeter测试" tabindex="-1"><a class="header-anchor" href="#_3-jmeter测试" aria-hidden="true">#</a> 3）Jmeter测试</h4>
<p>选择《热点参数限流 QPS1》：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716120754527.png" alt="image-20210716120754527"></p>
<p>这里发起请求的QPS为5.</p>
<p>包含3个http请求：</p>
<p>普通参数，QPS阈值为2</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716120840501.png" alt="image-20210716120840501"></p>
<p>运行结果：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716121105567.png" alt="image-20210716121105567"></p>
<p>例外项，QPS阈值为4</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716120900365.png" alt="image-20210716120900365"></p>
<p>运行结果：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716121201630.png" alt="image-20210716121201630"></p>
<p>例外项，QPS阈值为10</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716120919131.png" alt="image-20210716120919131"></p>
<p>运行结果：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716121220305.png" alt="image-20210716121220305"></p>
<h1 id="_3-隔离和降级" tabindex="-1"><a class="header-anchor" href="#_3-隔离和降级" aria-hidden="true">#</a> 3.隔离和降级</h1>
...
<h2 id="_3-1-feignclient整合sentinel" tabindex="-1"><a class="header-anchor" href="#_3-1-feignclient整合sentinel" aria-hidden="true">#</a> 3.1.FeignClient整合Sentinel</h2>
<p>SpringCloud中，微服务调用都是通过Feign来实现的，因此做客户端保护必须整合Feign和Sentinel。</p>
<h3 id="_3-1-1-修改配置-开启sentinel功能" tabindex="-1"><a class="header-anchor" href="#_3-1-1-修改配置-开启sentinel功能" aria-hidden="true">#</a> 3.1.1.修改配置，开启sentinel功能</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-1-2-编写失败降级逻辑" tabindex="-1"><a class="header-anchor" href="#_3-1-2-编写失败降级逻辑" aria-hidden="true">#</a> 3.1.2.编写失败降级逻辑</h3>
...
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716122403502.png" alt="image-20210716122403502"></p>
<p>代码：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>步骤三</strong>：在feing-api项目中的UserClient接口中使用UserClientFallbackFactory：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重启后，访问一次订单查询业务，然后查看sentinel控制台，可以看到新的簇点链路：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716123705780.png" alt="image-20210716123705780"></p>
<h3 id="_3-1-3-总结" tabindex="-1"><a class="header-anchor" href="#_3-1-3-总结" aria-hidden="true">#</a> 3.1.3.总结</h3>
...
<h2 id="_3-2-线程隔离-舱壁模式" tabindex="-1"><a class="header-anchor" href="#_3-2-线程隔离-舱壁模式" aria-hidden="true">#</a> 3.2.线程隔离（舱壁模式）</h2>
<h3 id="_3-2-1-线程隔离的实现方式" tabindex="-1"><a class="header-anchor" href="#_3-2-1-线程隔离的实现方式" aria-hidden="true">#</a> 3.2.1.线程隔离的实现方式</h3>
<p>线程隔离有两种方式实现：</p>
<ul>
<li>
<p>线程池隔离</p>
...
<p>如图：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716123036937.png" alt="image-20210716123036937"></p>
<p><strong>线程池隔离</strong>：给每个服务调用业务分配一个线程池，利用线程池本身实现隔离效果</p>
<p><strong>信号量隔离</strong>：不创建线程池，而是计数器模式，记录业务使用的线程数量，达到信号量上限时，禁止新的请求。</p>
<p>两者的优缺点：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716123240518.png" alt="image-20210716123240518"></p>
<h3 id="_3-2-2-sentinel的线程隔离" tabindex="-1"><a class="header-anchor" href="#_3-2-2-sentinel的线程隔离" aria-hidden="true">#</a> 3.2.2.sentinel的线程隔离</h3>
<p><strong>用法说明</strong>：</p>
<p>在添加限流规则时，可以选择两种阈值类型：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716123411217.png" alt="image-20210716123411217"></p>
<ul>
<li>
...
<h4 id="_1-配置隔离规则" tabindex="-1"><a class="header-anchor" href="#_1-配置隔离规则" aria-hidden="true">#</a> 1）配置隔离规则</h4>
<p>选择feign接口后面的流控按钮：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716123831992.png" alt="image-20210716123831992"></p>
<p>填写表单：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716123936844.png" alt="image-20210716123936844"></p>
<h4 id="_2-jmeter测试-2" tabindex="-1"><a class="header-anchor" href="#_2-jmeter测试-2" aria-hidden="true">#</a> 2）Jmeter测试</h4>
<p>选择《阈值类型-线程数&lt;2》：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716124229894.png" alt="image-20210716124229894"></p>
<p>一次发生10个请求，有较大概率并发线程数超过2，而超出的请求会走之前定义的失败降级逻辑。</p>
<p>查看运行结果：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716124147820.png" alt="image-20210716124147820"></p>
<p>发现虽然结果都是通过了，不过部分请求得到的响应是降级返回的null信息。</p>
<h3 id="_3-2-3-总结" tabindex="-1"><a class="header-anchor" href="#_3-2-3-总结" aria-hidden="true">#</a> 3.2.3.总结</h3>
<p>线程隔离的两种手段是？</p>
<ul>
<li>
<p>信号量隔离</p>
...
<h2 id="_3-3-熔断降级" tabindex="-1"><a class="header-anchor" href="#_3-3-熔断降级" aria-hidden="true">#</a> 3.3.熔断降级</h2>
...
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716130958518.png" alt="image-20210716130958518"></p>
<p>状态机包括三个状态：</p>
<ul>
...
<h3 id="_3-3-1-慢调用" tabindex="-1"><a class="header-anchor" href="#_3-3-1-慢调用" aria-hidden="true">#</a> 3.3.1.慢调用</h3>
<p><strong>慢调用</strong>：业务的响应时长（RT）大于指定时长的请求认定为慢调用请求。在指定时间内，如果请求数量超过设定的最小数量，慢调用比例大于设定的阈值，则触发熔断。</p>
<p>例如：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716145934347.png" alt="image-20210716145934347"></p>
...
<h4 id="_1-设置慢调用" tabindex="-1"><a class="header-anchor" href="#_1-设置慢调用" aria-hidden="true">#</a> 1）设置慢调用</h4>
<p>修改user-service中的/user/{id}这个接口的业务。通过休眠模拟一个延迟时间：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716150234787.png" alt="image-20210716150234787"></p>
<p>此时，orderId=101的订单，关联的是id为1的用户，调用时长为60ms：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716150510956.png" alt="image-20210716150510956"></p>
<p>orderId=102的订单，关联的是id为2的用户，调用时长为非常短；</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716150605208.png" alt="image-20210716150605208"></p>
<h4 id="_2-设置熔断规则" tabindex="-1"><a class="header-anchor" href="#_2-设置熔断规则" aria-hidden="true">#</a> 2）设置熔断规则</h4>
<p>下面，给feign接口设置降级规则：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716150654094.png" alt="image-20210716150654094"></p>
<p>规则：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716150740434.png" alt="image-20210716150740434"></p>
<p>超过50ms的请求都会被认为是慢请求</p>
<h4 id="_3-测试" tabindex="-1"><a class="header-anchor" href="#_3-测试" aria-hidden="true">#</a> 3）测试</h4>
<p>在浏览器访问：http://localhost:8088/order/101，快速刷新5次，可以发现：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716150911004.png" alt="image-20210716150911004"></p>
<p>触发了熔断，请求时长缩短至5ms，快速失败了，并且走降级逻辑，返回的null</p>
<p>在浏览器访问：http://localhost:8088/order/102，竟然也被熔断了：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716151107785.png" alt="image-20210716151107785"></p>
<h3 id="_3-3-2-异常比例、异常数" tabindex="-1"><a class="header-anchor" href="#_3-3-2-异常比例、异常数" aria-hidden="true">#</a> 3.3.2.异常比例、异常数</h3>
<p><strong>异常比例或异常数</strong>：统计指定时间内的调用，如果调用次数超过指定请求数，并且出现异常的比例达到设定的比例阈值（或超过指定异常数），则触发熔断。</p>
<p>例如，一个异常比例设置：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716131430682.png" alt="image-20210716131430682"></p>
<p>解读：统计最近1000ms内的请求，如果请求量超过10次，并且异常比例不低于0.4，则触发熔断。</p>
<p>一个异常数设置：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716131522912.png" alt="image-20210716131522912"></p>
<p>解读：统计最近1000ms内的请求，如果请求量超过10次，并且异常比例不低于2次，则触发熔断。</p>
<p><strong>案例</strong></p>
<p>需求：给 UserClient的查询用户接口设置降级规则，统计时间为1秒，最小请求数量为5，失败阈值比例为0.4，熔断时长为5s</p>
<h4 id="_1-设置异常请求" tabindex="-1"><a class="header-anchor" href="#_1-设置异常请求" aria-hidden="true">#</a> 1）设置异常请求</h4>
<p>首先，修改user-service中的/user/{id}这个接口的业务。手动抛出异常，以触发异常比例的熔断：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716151348183.png" alt="image-20210716151348183"></p>
<p>也就是说，id 为 2时，就会触发异常</p>
<h4 id="_2-设置熔断规则-1" tabindex="-1"><a class="header-anchor" href="#_2-设置熔断规则-1" aria-hidden="true">#</a> 2）设置熔断规则</h4>
<p>下面，给feign接口设置降级规则：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716150654094.png" alt="image-20210716150654094"></p>
<p>规则：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716151538785.png" alt="image-20210716151538785"></p>
<p>在5次请求中，只要异常比例超过0.4，也就是有2次以上的异常，就会触发熔断。</p>
<h4 id="_3-测试-1" tabindex="-1"><a class="header-anchor" href="#_3-测试-1" aria-hidden="true">#</a> 3）测试</h4>
<p>在浏览器快速访问：http://localhost:8088/order/102，快速刷新5次，触发熔断：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716151722916.png" alt="image-20210716151722916"></p>
<p>此时，我们去访问本来应该正常的103：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716151844817.png" alt="image-20210716151844817"></p>
<h1 id="_4-授权规则" tabindex="-1"><a class="header-anchor" href="#_4-授权规则" aria-hidden="true">#</a> 4.授权规则</h1>
<p>授权规则可以对请求方来源做判断和控制。</p>
<h2 id="_4-1-授权规则" tabindex="-1"><a class="header-anchor" href="#_4-1-授权规则" aria-hidden="true">#</a> 4.1.授权规则</h2>
<h3 id="_4-1-1-基本规则" tabindex="-1"><a class="header-anchor" href="#_4-1-1-基本规则" aria-hidden="true">#</a> 4.1.1.基本规则</h3>
...
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716152010750.png" alt="image-20210716152010750"></p>
<ul>
<li>
...
<p>比如：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716152349191.png" alt="image-20210716152349191"></p>
<p>我们允许请求从gateway到order-service，不允许浏览器访问order-service，那么白名单中就要填写<strong>网关的来源名称（origin）</strong>。</p>
<h3 id="_4-1-2-如何获取origin" tabindex="-1"><a class="header-anchor" href="#_4-1-2-如何获取origin" aria-hidden="true">#</a> 4.1.2.如何获取origin</h3>
<p>Sentinel是通过RequestOriginParser这个接口的parseOrigin来获取请求的来源的。</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">RequestOriginParser</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个方法的作用就是从request对象中，获取请求者的origin值并返回。</p>
...
<h3 id="_4-1-3-给网关添加请求头" tabindex="-1"><a class="header-anchor" href="#_4-1-3-给网关添加请求头" aria-hidden="true">#</a> 4.1.3.给网关添加请求头</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样，从gateway路由的所有请求都会带上origin头，值为gateway。而从其它地方到达微服务的请求则没有这个头。</p>
<h3 id="_4-1-4-配置授权规则" tabindex="-1"><a class="header-anchor" href="#_4-1-4-配置授权规则" aria-hidden="true">#</a> 4.1.4.配置授权规则</h3>
<p>接下来，我们添加一个授权规则，放行origin值为gateway的请求。</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716153250134.png" alt="image-20210716153250134"></p>
<p>配置如下：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716153301069.png" alt="image-20210716153301069"></p>
<p>现在，我们直接跳过网关，访问order-service服务：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716153348396.png" alt="image-20210716153348396"></p>
<p>通过网关访问：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716153434095.png" alt="image-20210716153434095"></p>
<h2 id="_4-2-自定义异常结果" tabindex="-1"><a class="header-anchor" href="#_4-2-自定义异常结果" aria-hidden="true">#</a> 4.2.自定义异常结果</h2>
<p>默认情况下，发生限流、降级、授权拦截时，都会抛出异常到调用方。异常结果都是flow limmiting（限流）。这样不够友好，无法得知是限流还是降级还是授权拦截。</p>
<h3 id="_4-2-1-异常类型" tabindex="-1"><a class="header-anchor" href="#_4-2-1-异常类型" aria-hidden="true">#</a> 4.2.1.异常类型</h3>
<p>而如果要自定义异常时的返回结果，需要实现BlockExceptionHandler接口：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">BlockExceptionHandler</span> <span class="token punctuation">{</span>
    <span class="token doc-comment comment">/**
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个方法有三个参数：</p>
<ul>
...
<h3 id="_4-2-2-自定义异常处理" tabindex="-1"><a class="header-anchor" href="#_4-2-2-自定义异常处理" aria-hidden="true">#</a> 4.2.2.自定义异常处理</h3>
...
<p>限流：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716153938887.png" alt="image-20210716153938887"></p>
<p>授权拦截时：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716154012736.png" alt="image-20210716154012736"></p>
<h1 id="_5-规则持久化" tabindex="-1"><a class="header-anchor" href="#_5-规则持久化" aria-hidden="true">#</a> 5.规则持久化</h1>
<p>现在，sentinel的所有规则都是内存存储，重启后所有规则都会丢失。在生产环境下，我们必须确保这些规则的持久化，避免丢失。</p>
<h2 id="_5-1-规则管理模式" tabindex="-1"><a class="header-anchor" href="#_5-1-规则管理模式" aria-hidden="true">#</a> 5.1.规则管理模式</h2>
...
<h3 id="_5-1-1-pull模式" tabindex="-1"><a class="header-anchor" href="#_5-1-1-pull模式" aria-hidden="true">#</a> 5.1.1.pull模式</h3>
<p>pull模式：控制台将配置的规则推送到Sentinel客户端，而客户端会将配置规则保存在本地文件或数据库中。以后会定时去本地文件或数据库中查询，更新本地规则。</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716154155238.png" alt="image-20210716154155238"></p>
<h3 id="_5-1-2-push模式" tabindex="-1"><a class="header-anchor" href="#_5-1-2-push模式" aria-hidden="true">#</a> 5.1.2.push模式</h3>
<p>push模式：控制台将配置规则推送到远程配置中心，例如Nacos。Sentinel客户端监听Nacos，获取配置变更的推送消息，完成本地配置更新。</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716154215456.png" alt="image-20210716154215456"></p>
<h2 id="_5-2-实现push模式" tabindex="-1"><a class="header-anchor" href="#_5-2-实现push模式" aria-hidden="true">#</a> 5.2.实现push模式</h2>
<p>详细步骤可以参考课前资料的《sentinel规则持久化》：</p>
<p><img src="@source/java8-9/day01-微服务保护/讲义/assets/image-20210716154255466.png" alt="image-20210716154255466"></p>
</div></template>
