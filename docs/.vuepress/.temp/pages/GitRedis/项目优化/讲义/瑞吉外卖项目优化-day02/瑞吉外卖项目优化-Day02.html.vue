...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825100741985.png" alt="image-20210825100741985" style="zoom:80%;" /> 
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825101438683.png" alt="image-20210825101438683" style="zoom:80%;" /> 
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825110417975.png" alt="image-20210825110417975"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825124800430.png" alt="image-20210825124800430"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825111414157.png" alt="image-20210825111414157"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825115719668.png" alt="image-20210825115719668"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825115853116.png" alt="image-20210825115853116"></p>
...
<blockquote>
<p>MySQL密码复杂程度说明:</p>
<p>​	<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825144818269.png" alt="image-20210825144818269"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825120355600.png" alt="image-20210825120355600"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825125156597.png" alt="image-20210825125156597"></p>
<p><strong>2). 重启Mysql服务</strong></p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>systemctl restart mysqld
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825142313382.png" alt="image-20210825142313382"></p>
<blockquote>
<p>MySQL命令行技巧：</p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825143518383.png" alt="image-20210825143518383"></p>
<p>2). 在master的itcast数据下创建user表, 刷新slave查看是否可以同步过去</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825143549689.png" alt="image-20210825143549689"></p>
<p>3). 在master的user表中插入一条数据, 刷新slave查看是否可以同步过去</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825143658516.png" alt="image-20210825143658516"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825145647274.png" alt="image-20210825145647274"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825160658477.png" alt="image-20210825160658477"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825161155163.png" alt="image-20210825161155163"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825162910711.png" alt="image-20210825162910711"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825163737687.png" alt="image-20210825163737687"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825164147056.png" alt="image-20210825164147056"></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825164227927.png" alt="image-20210825164227927"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825170601641.png" alt="image-20210825170601641"></p>
<p>控制台输出日志，可以看到操作master主库：</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825172748209.png" alt="image-20210825172748209"></p>
<p><strong>2). 修改数据</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825171507059.png" alt="image-20210825171507059"></p>
<p>控制台输出日志，可以看到操作master主库：</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825172534790.png" alt="image-20210825172534790"></p>
<p><strong>3). 查询数据</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825171609997.png" alt="image-20210825171609997"></p>
<p>控制台输出日志，可以看到操作slave主库：</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825171623011.png" alt="image-20210825171623011"></p>
<p><strong>4). 删除数据</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825172329600.png" alt="image-20210825172329600"></p>
<p>控制台输出日志，可以看到操作master主库：</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825172353414.png" alt="image-20210825172353414"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825175039571.png" alt="image-20210825175039571"></p>
<p>这样做的话，我们之前自己开发时，添加的测试数据都还在的，便于测试。</p>
<p><strong>2). 在主数据库master中，创建数据库reggie，并导入该SQL文件</strong></p>
<p>master中创建数据库，会自动同步至slave从库</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825175416295.png" alt="image-20210825175416295"></p>
<p>在master的reggie中导入sql文件</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825175747138.png" alt="image-20210825175747138"></p>
...
<p>查询操作：</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825181207319.png" alt="image-20210825181207319"></p>
<p>更新操作：</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825181524065.png" alt="image-20210825181524065" style="zoom:80%;" /> 
<p>插入操作：</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825181915511.png" alt="image-20210825181915511" style="zoom:80%;" /> 
<p>删除操作：</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825182259837.png" alt="image-20210825182259837" style="zoom:80%;" /> 
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825183830252.png" alt="image-20210825183830252" style="zoom:80%;" /> 
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825183900307.png" alt="image-20210825183900307"></p>
<p>然后，再将v1.1的代码，合并到master分支，然后推送至远程仓库。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210825184018801.png" alt="image-20210825184018801"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210829234142590.png" alt="image-20210829234142590"></p>
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210829234623737.png" alt="image-20210829234623737" style="zoom:80%;" /> 
<p>在本项目中，我们所学习的Nginx选择的是稳定版本的1.16这个版本，我们可以直接从官网下载，当然在我们的课程资料中也已经提供了该版本的安装包。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210829235301014.png" alt="image-20210829235301014"></p>
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830000933352.png" alt="image-20210830000933352" style="zoom:90%;" /> 
<blockquote>
<p>备注：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830223435585.png" alt="image-20210830223435585"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830223511878.png" alt="image-20210830223511878"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830224019661.png" alt="image-20210830224019661"></p>
<p>注意： nginx服务启动后，默认就会有两个进程。</p>
<p>启动之后，我们可以直接访问Nginx的80端口， http://192.168.200.200</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830224605952.png" alt="image-20210830224605952" style="zoom:80%;" /> 
<blockquote>
<p>注意：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830224121489.png" alt="image-20210830224121489"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830225544343.png" alt="image-20210830225544343"></p>
<p>修改完配置文件之后，需要执行 source /etc/profile 使文件生效。 接下来，我们就可以在任意目录下执行nginx的指令了，如：</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830225702899.png" alt="image-20210830225702899"></p>
...
<p>具体结构图如下:</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830230827686.png" alt="image-20210830230827686" style="zoom:80%;" /> 
<blockquote>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830232238402.png" alt="image-20210830232238402"></p>
<p><strong>2). 启动nginx</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830232419462.png" alt="image-20210830232419462"></p>
<p><strong>3). 访问</strong></p>
<p>http://192.168.200.200/hello.html</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830232529524.png" alt="image-20210830232529524" style="zoom:80%;" /> 
<p>http://192.168.200.200 ， 访问该地址，访问的是nginx的默认首页</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830232857289.png" alt="image-20210830232857289" style="zoom:81%;" /> 
<p><strong>4). 配置首页</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830232720821.png" alt="image-20210830232720821"></p>
<p>如果我们需要将hello.html作为nginx的首页，可以修改location的index指令，配置为hello.html，如下：</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830233019489.png" alt="image-20210830233019489"></p>
<p>配置完毕后，我们可以通过指令，来检查配置文件是否配置正确： nginx -t</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830233122708.png" alt="image-20210830233122708"></p>
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830233336916.png" alt="image-20210830233336916" style="zoom:80%;" /> 
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830233450415.png" alt="image-20210830233450415"></p>
<p>2). 反向代理</p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830233634695.png" alt="image-20210830233634695"></p>
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210830235803013.png" alt="image-20210830235803013" style="zoom:67%;" /> 
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210831000152199.png" alt="image-20210831000152199"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210831000747805.png" alt="image-20210831000747805" style="zoom:80%;" /> 
<p><strong>3). 检查配置文件，并重新加载</strong></p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>nginx -t
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210831001021252.png" alt="image-20210831001021252"></p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>nginx -s reload
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>4). 访问</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210831001347257.png" alt="image-20210831001347257"></p>
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210831080743617.png" alt="image-20210831080743617" style="zoom:80%;" />  
...
<tbody>
<tr>
<td><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210831081023098.png" alt="image-20210831081023098"></td>
<td>8080</td>
<td>/hello</td>
<td>8080</td>
</tr>
<tr>
<td><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210831081038807.png" alt="image-20210831081038807"></td>
<td>8081</td>
<td>/hello</td>
<td>8081</td>
</tr>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210831081513575.png" alt="image-20210831081513575"></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210831081544582.png" alt="image-20210831081544582"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210831081939508.png" alt="image-20210831081939508"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day02/assets/image-20210831082339085.png" alt="image-20210831082339085"></p>
