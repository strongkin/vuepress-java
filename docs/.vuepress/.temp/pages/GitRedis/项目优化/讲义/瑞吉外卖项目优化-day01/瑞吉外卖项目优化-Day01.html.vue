...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210819232120838.png" alt="image-20210819232120838"></p>
<blockquote>
<p>2). 解决该问题的方法</p>
</blockquote>
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210820000329886.png" alt="image-20210820000329886" style="zoom:80%;" /> 
<p><strong>2). idea-创建本地仓库</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210820000700459.png" alt="image-20210820000700459"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210820001119649.png" alt="image-20210820001119649"></p>
<p><strong>4). idea-提交并推送本地代码</strong></p>
<p>A. 添加项目文件进暂存区</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210820001232154.png" alt="image-20210820001232154"  /> 
<p>B. 提交代码</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210820001805504.png" alt="image-20210820001805504"  /> 
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210820002006653.png" alt="image-20210820002006653"></p>
<p>C. 推送代码到远程仓库</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210820002159587.png" alt="image-20210820002159587"></p>
<p><strong>5). 查看gitee远程仓库</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210820002723619.png" alt="image-20210820002723619"></p>
<p><strong>6). 创建分支</strong></p>
<p>目前默认git中只有一个主分支master，我们接下来进行缓存的优化，就不在master分支来操作了，我们需要在git上创建一个单独的分支v1.0，缓存的优化，我们就在该分支上进行操作。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210820003303544.png" alt="image-20210820003303544"></p>
<p>当前创建的v1.0分支，是基于master分支创建出来的，所以目前master分支的代码， 和v1.0分支的代码是完全一样的，接下来把v1.0的代码也推送至远程仓库。</p>
<p><strong>7). 推送分支代码到远程</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210820003516900.png" alt="image-20210820003516900"></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210820003545764.png" alt="image-20210820003545764"></p>
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210821091441695.png" alt="image-20210821091441695" style="zoom:80%;" /> 
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822003112692.png" alt="image-20210822003112692"></p>
<p>2). 如果使用我们自定义的RedisTemplate, key的序列化方式使用的是StringRedisSerializer, 也就是字符串形式, 最终效果如下:</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822003408377.png" alt="image-20210822003408377"></p>
<p>3). 定义了两个bean会不会出现冲突呢? 答案是不会, 因为源码如下:</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210821092401172.png" alt="image-20210821092401172" style="zoom:80%;" /> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210821194944557.png" alt="image-20210821194944557"  /> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210821195329342.png" alt="image-20210821195329342"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210821200212767.png" alt="image-20210821200212767"></p>
<p>通过控制台的日志，我们可以看到生成的验证码：</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822002439892.png" alt="image-20210822002439892"></p>
<p><strong>2). 通过Redis的图形化界面工具查看Redis中的数据</strong></p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822003550941.png" alt="image-20210822003550941" style="zoom:97%;" /> 
<p><strong>3). 在登录界面填写验证码登录完成后,查看Redis中的数据是否删除</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822003732542.png" alt="image-20210822003732542"></p>
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822010136819.png" alt="image-20210822010136819" style="zoom:80%;" /> 
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token operator">|</span> 改造的方法 <span class="token operator">|</span> redis的数据类型 <span class="token operator">|</span> redis缓存的key                              <span class="token operator">|</span> redis缓存的value <span class="token operator">|</span>
<span class="token operator">|</span> <span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span> <span class="token operator">|</span> <span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">-</span> <span class="token operator">|</span> <span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">-</span> <span class="token operator">|</span> <span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span><span class="token operator">--</span> <span class="token operator">|</span>
<span class="token operator">|</span> list       <span class="token operator">|</span> string          <span class="token operator">|</span> dish_分类<span class="token class-name">Id_</span>状态 <span class="token punctuation">,</span> 比如<span class="token operator">:</span> dish_12323232323_1 <span class="token operator">|</span> <span class="token class-name">List</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">DishDto</span><span class="token punctuation">></span></span>    <span class="token operator">|</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>1). 在DishController中注入RedisTemplate</strong></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Autowired</span>
<span class="token keyword">private</span> <span class="token class-name">RedisTemplate</span> redisTemplate<span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822011323316.png" alt="image-20210822011323316" style="zoom:90%;" /> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822011714110.png" alt="image-20210822011714110" style="zoom:90%;" /> 
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822013114996.png" alt="image-20210822013114996" style="zoom:80%;" /> 
...
<span class="token class-name">String</span> key <span class="token operator">=</span> <span class="token string">"dish_"</span> <span class="token operator">+</span> dishDto<span class="token punctuation">.</span><span class="token function">getCategoryId</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">+</span> <span class="token string">"_1"</span><span class="token punctuation">;</span>
redisTemplate<span class="token punctuation">.</span><span class="token function">delete</span><span class="token punctuation">(</span>key<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822013609299.png" alt="image-20210822013609299"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822221038509.png" alt="image-20210822221038509"></p>
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822222206452.png" alt="image-20210822222206452" style="zoom:80%;" /> 
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822222244727.png" alt="image-20210822222244727" style="zoom:80%;" /> 
<p><strong>2). 合并代码到master分支</strong></p>
<p>A. 将代码切换到master分支</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822222756572.png" alt="image-20210822222756572" style="zoom:80%;" /> 
<p>B. 将v1.0分支的代码合并到当前master分支</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822223314087.png" alt="image-20210822223314087" style="zoom:80%;" /> 
<p>C. 将master分支合并后代码推送到Gitee</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822223837020.png" alt="image-20210822223837020" style="zoom:80%;" /> 
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822223912803.png" alt="image-20210822223912803" style="zoom:80%;" /> 
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822230236957.png" alt="image-20210822230236957"></p>
<p><strong>2). 导入基础工程</strong></p>
<p>基础环境的代码，在我们今天的资料中已经准备好了， 大家只需要将这个工程导入进来就可以了。导入进来的工程结构如下：</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822225934512.png" alt="image-20210822225934512"></p>
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822231333527.png" alt="image-20210822231333527" style="zoom:80%;" /> 
<p>我们可以看到CacheManager是一个接口，默认的实现有以下几种 ；</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822231217450.png" alt="image-20210822231217450"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822231616569.png" alt="image-20210822231616569"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822233438182.png" alt="image-20210822233438182"></p>
<p>第一次访问时，缓存中的数据是空的，因为save方法执行完毕后才会缓存数据。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822233724439.png" alt="image-20210822233724439"></p>
<p>第二次访问时，我们通过debug可以看到已经有一条数据了，就是上次保存的数据，已经缓存了，缓存的key就是用户的id。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210822234105085.png" alt="image-20210822234105085"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823000431356.png" alt="image-20210823000431356"></p>
<p>删除数据时，通过debug我们可以看到已经缓存的4条数据：</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823000458089.png" alt="image-20210823000458089"></p>
<p>当执行完delete操作之后，我们再次保存一条数据，在保存的时候debug查看一下删除的ID值是否已经被删除。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823000733218.png" alt="image-20210823000733218"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823002517941.png" alt="image-20210823002517941"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823002907048.png" alt="image-20210823002907048"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823005220230.png" alt="image-20210823005220230"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823010810680.png" alt="image-20210823010810680"></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823010742530.png" alt="image-20210823010742530"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823232419408.png" alt="image-20210823232419408"></p>
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823233406888.png" alt="image-20210823233406888" style="zoom:80%;" /> 
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823233514356.png" alt="image-20210823233514356"></p>
<p>==为什么会报出这个错误呢？==</p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823233904520.png" alt="image-20210823233904520"></p>
<p>修复完毕之后，再次重新测试，访问套餐分类下对应的套餐列表数据后，我们会看到Redis中确实可以缓存对应的套餐列表数据。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823234146526.png" alt="image-20210823234146526"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823235612400.png" alt="image-20210823235612400"></p>
<p>然后，在idea中切换到master分支，然后将v1.0分支的代码合并到master。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210823235822139.png" alt="image-20210823235822139"></p>
<p>再将合并后的master分支的代码，推送到远程仓库。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day01/assets/image-20210824000057260.png" alt="image-20210824000057260"></p>
</div></template>
