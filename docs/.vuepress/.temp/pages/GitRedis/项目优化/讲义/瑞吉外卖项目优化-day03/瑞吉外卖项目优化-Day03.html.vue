...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210831232554721.png" alt="image-20210831232554721"></p>
<p>主要存在以下几点问题：</p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901082121874.png" alt="image-20210901082121874"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901084945348.png" alt="image-20210901084945348">            <img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901085057990.png" alt="image-20210901085057990"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901110936381.png" alt="image-20210901110936381"></p>
...
<p>注册账号，登录平台</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901115408908.png" alt="image-20210901115408908"></p>
...
<p>1). 创建项目</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901123709298.png" alt="image-20210901123709298"></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901124623325.png" alt="image-20210901124623325"></p>
<p>2). 添加分类</p>
<p>在当前项目中,有针对于员工、菜品、套餐、订单的操作，我们在进行接口维护时，可以针对接口进行分类，如果没有对应的分类，我们自己添加分类。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901125311166.png" alt="image-20210901125311166"></p>
<p>3). 添加接口</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901125517274.png" alt="image-20210901125517274"></p>
<p>接口基本信息录入之后，添加提交，就可以看到该接口的基本信息：</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901125617777.png" alt="image-20210901125617777"></p>
<p>但是目前，接口中我们并未指定请求参数，响应数据等信息，我们可以进一步点击编辑，对该接口 详情进行编辑处理。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901140052897.png" alt="image-20210901140052897"></p>
<p>4). 运行接口</p>
<p>Yapi也提供了接口测试功能，当我们接口编辑完毕后，后端服务的代码开发完毕，启动服务，就可以使用Yapi进行接口测试了。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901140924816.png" alt="image-20210901140924816"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901150153468.png" alt="image-20210901150153468"></p>
<p>而在导出的html文件或md文件中，主要描述的就是接口的基本信息， 包括： 请求路径、请求方式、接口描述、请求参数、返回数据等信息。展示形式如下：</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901150401976.png" alt="image-20210901150401976" style="zoom: 80%;" /> 
...
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901151127926.png" alt="image-20210901151127926" style="zoom:80%;" /> 
<p>导入过程中出现的确认弹窗，选择&quot;确认&quot;。</p>
<img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901151508478.png" alt="image-20210901151508478" style="zoom:80%;" /> 
<p>导入成功之后，我们就可以在Yapi平台查看到已导入的接口。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901151721356.png" alt="image-20210901151721356"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901160434736.png" alt="image-20210901160434736"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901171132242.png" alt="image-20210901171132242"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901200739975.png" alt="image-20210901200739975"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901201229838.png" alt="image-20210901201229838"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901214706928.png" alt="image-20210901214706928"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901215244539.png" alt="image-20210901215244539"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901221213897.png" alt="image-20210901221213897"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901221425159.png" alt="image-20210901221425159"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901231943256.png" alt="image-20210901231943256"></p>
<p>将整个dist目录上传至/usr/local/nginx/html目录下</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901231924028.png" alt="image-20210901231924028"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901232931577.png" alt="image-20210901232931577"></p>
<p><strong>3). 通过nginx访问前端工程</strong></p>
<p>http://192.168.138.100</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901233135468.png" alt="image-20210901233135468"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210901234142706.png" alt="image-20210901234142706"></p>
...
<p>A. 确认JDK环境</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210902002307537.png" alt="image-20210902002307537"></p>
<p>B. 确认Git环境</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210902002328883.png" alt="image-20210902002328883"></p>
<p>C. 确认Maven环境</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210902002357900.png" alt="image-20210902002357900"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210902004033417.png" alt="image-20210902004033417"></p>
<p><strong>2). 将资料中提供的reggieStart.sh文件上传到服务器B，通过chmod命令设置执行权限</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210902004308106.png" alt="image-20210902004308106"></p>
<p><strong>3). 执行reggieStart.sh脚本文件，自动部署项目</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210902005320980.png" alt="image-20210902005320980"></p>
<p>执行完shell脚本之后，我们可以通过 ps -ef|grep java 指令，查看服务是否启动。</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210902005450399.png" alt="image-20210902005450399"></p>
<p><strong>4). 访问系统测试</strong></p>
<p>http://192.168.138.101/</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210902005640875.png" alt="image-20210902005640875"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210902005957772.png" alt="image-20210902005957772"></p>
...
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210902010223733.png" alt="image-20210902010223733"></p>
<p><strong>2). 执行shell脚本,进行自动化部署</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210902010440908.png" alt="image-20210902010440908"></p>
<p><strong>3). 将本地的测试图片文件夹img(整个文件夹)上传到服务器B的/usr/local目录下</strong></p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210902010704691.png" alt="image-20210902010704691"></p>
<p><strong>4).访问测试</strong></p>
<p>http://192.168.138.101/</p>
<p><img src="@source/gitredis/项目优化/讲义/瑞吉外卖项目优化-day03/assets/image-20210902010952388.png" alt="image-20210902010952388"></p>
</div></template>
