<template><div><h1 id="并发篇" tabindex="-1"><a class="header-anchor" href="#并发篇" aria-hidden="true">#</a> 并发篇</h1>
<h2 id="_1-线程状态" tabindex="-1"><a class="header-anchor" href="#_1-线程状态" aria-hidden="true">#</a> 1. 线程状态</h2>
...
<p><img src="@source/interview/day02-并发篇/讲义/img/image-20210831090722658.png" alt="image-20210831090722658"></p>
<p>分别是</p>
<ul>
<li>新建
<ul>
...
<p><img src="@source/interview/day02-并发篇/讲义/img/image-20210831092652602.png" alt="image-20210831092652602"></p>
<ul>
...
<h2 id="_2-线程池" tabindex="-1"><a class="header-anchor" href="#_2-线程池" aria-hidden="true">#</a> 2. 线程池</h2>
<p><strong>要求</strong></p>
<ul>
...
<p><img src="@source/interview/day02-并发篇/讲义/img/image-20210831093204388.png" alt="image-20210831093204388"></p>
<blockquote>
<p><em><strong>代码说明</strong></em></p>
<p>day02.TestThreadPoolExecutor 以较为形象的方式演示了线程池的核心组成</p>
</blockquote>
<h2 id="_3-wait-vs-sleep" tabindex="-1"><a class="header-anchor" href="#_3-wait-vs-sleep" aria-hidden="true">#</a> 3. wait vs sleep</h2>
<p><strong>要求</strong></p>
<ul>
<li>能够说出二者区别</li>
</ul>
...
<h2 id="_4-lock-vs-synchronized" tabindex="-1"><a class="header-anchor" href="#_4-lock-vs-synchronized" aria-hidden="true">#</a> 4. lock vs synchronized</h2>
<p><strong>要求</strong></p>
<ul>
...
<h2 id="_5-volatile" tabindex="-1"><a class="header-anchor" href="#_5-volatile" aria-hidden="true">#</a> 5. volatile</h2>
<p><strong>要求</strong></p>
<ul>
...
<h2 id="_6-悲观锁-vs-乐观锁" tabindex="-1"><a class="header-anchor" href="#_6-悲观锁-vs-乐观锁" aria-hidden="true">#</a> 6. 悲观锁 vs 乐观锁</h2>
<p><strong>要求</strong></p>
<ul>
<li>掌握悲观锁和乐观锁的区别</li>
</ul>
...
<h2 id="_7-hashtable-vs-concurrenthashmap" tabindex="-1"><a class="header-anchor" href="#_7-hashtable-vs-concurrenthashmap" aria-hidden="true">#</a> 7. Hashtable vs ConcurrentHashMap</h2>
<p><strong>要求</strong></p>
<ul>
...
<ul>
<li>数据结构：<code v-pre>Segment(大数组) + HashEntry(小数组) + 链表</code>，每个 Segment 对应一把锁，如果多个线程访问不同的 Segment，则不会冲突</li>
...
<ul>
<li>数据结构：<code v-pre>Node 数组 + 链表或红黑树</code>，数组的每个头节点作为锁，如果多个线程访问的头节点不同，则不会冲突。首次生成头节点时如果发生竞争，利用 cas 而非 syncronized，进一步提升性能</li>
...
<h2 id="_8-threadlocal" tabindex="-1"><a class="header-anchor" href="#_8-threadlocal" aria-hidden="true">#</a> 8. ThreadLocal</h2>
<p><strong>要求</strong></p>
<ul>
